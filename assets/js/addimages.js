//Show TABLE
        ...
        var changeImg = function (){
            ...
            for (var i = 0; i < thiselem.files.length; i++) {
                ...
                htmltext += ('<div class="img-setname"><img src="' + window.URL.createObjectURL(file[i]) + '"><div class="col-md-12 px250"><input class="input-decs" name="images[]" value="' + (thiselem.files[i].name).substring(0, thiselem.files[i].name.lastIndexOf(".")) + '" placeholder="Название фотографий" class="" type="text"></div></div>');
